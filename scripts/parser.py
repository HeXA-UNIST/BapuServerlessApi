...
기숙사 식당 식단표에서 왼쪽에 있는 구분이 할랄(7,000원)일 경우 restaurant_name 을 기숙사_식당_할랄 이 되도록 해줘.
기숙사 식단표 사진에 최소 요일당 1개의 할랄 식단이 표함되어있으니, 너도 최소한 요일의 수만큼 기숙사_식당_할랄 을 출력해야해.
너는 반드시 주어진 사진에 있는 모든 식단을 출력해야하며 위 지시사항을 위반할 경우 즉시 종료되며 벌점을 받게돼.
"""
